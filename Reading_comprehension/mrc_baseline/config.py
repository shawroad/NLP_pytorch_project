...
def set_args():
    ...
    parser.add_argument("--train_batch_size", default=12, type=int, help="训练的批次大小")
    parser.add_argument("--eval_batch_size", default=12, type=int, help="验证的批次大小")
    ...
    parser.add_argument("--num_train_epochs", default=10, type=int, help="总共把数据训练几轮 和max_steps设置一个就行")
    ...
    parser.add_argument("--save_steps", default=300, type=float, help="多少步保存一下模型")
