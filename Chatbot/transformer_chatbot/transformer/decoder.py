...
class Decoder(nn.Module):
    ...
    def __init__(
            self, sos_id=Config.sos_id, eos_id=Config.eos_id,
            n_tgt_vocab=Config.vocab_size, d_word_vec=512,
    ...
    def preprocess(self, padded_input):
        ...
        """
        ys = [y[y != Config.IGNORE_ID] for y in padded_input]  # parse padded ys
