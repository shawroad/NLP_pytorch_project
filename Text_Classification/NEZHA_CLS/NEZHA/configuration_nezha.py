...
class NeZhaConfig(PretrainedConfig):
    r"""
        This is the configuration class to store the configuration of an :class:`~my_transformers.AlbertModel`.
        ...
        Configuration objects inherit from  :class:`~my_transformers.PretrainedConfig` and can be used
        to control the model outputs. Read the documentation from  :class:`~my_transformers.PretrainedConfig`
        ...
        Args:
            vocab_size (:obj:`int`, optional, defaults to 30000):
                ...
                can be represented by the `inputs_ids` passed to the forward method of :class:`~my_transformers.AlbertModel`.
            ...
            type_vocab_size (:obj:`int`, optional, defaults to 2):
                The vocabulary size of the `token_type_ids` passed into :class:`~my_transformers.AlbertModel`.
