...
class NeZhaEncoder(nn.Module):
    def __init__(self, config):
        ...
        self.relative_positions_encoding = relative_position_encoding(
            max_length=config.max_position_embeddings,
            depth=int(config.hidden_size / config.num_attention_heads),
            max_relative_position=config.max_relative_position)
        if torch.cuda.is_available():
            self.relative_positions_encoding = self.relative_positions_encoding.cuda()
...
class BertForPreTrainingOutput(ModelOutput):
    """
    Output type of :class:`~my_transformers.BertForPreTraining`.
...
BERT_START_DOCSTRING = r"""
    ...
    This model inherits from :class:`~my_transformers.PreTrainedModel`. Check the superclass documentation for the generic
    ...
    Parameters:
        config (:class:`~my_transformers.BertConfig`): Model configuration class with all the parameters of the model.
            ...
            configuration. Check out the :meth:`~my_transformers.PreTrainedModel.from_pretrained` method to load the model
            weights.
"""
...
BERT_INPUTS_DOCSTRING = r"""
    Args:
        input_ids (:obj:`torch.LongTensor` of shape :obj:`({0})`):
            ...
            Indices can be obtained using :class:`~my_transformers.BertTokenizer`. See
            :meth:`my_transformers.PreTrainedTokenizer.encode` and :meth:`my_transformers.PreTrainedTokenizer.__call__` for
            details.
        ...
        return_dict (:obj:`bool`, `optional`):
            Whether or not to return a :class:`~my_transformers.file_utils.ModelOutput` instead of a plain tuple.
"""
...
class BertForPreTraining(BertPreTrainedModel):
    ...
    def forward(
        ...
        Example::
            ...
            >>> from my_transformers import BertTokenizer, BertForPreTraining
            >>> import torch
...
class BertLMHeadModel(BertPreTrainedModel):
    ...
    def forward(
        ...
        Example::
            ...
            >>> from my_transformers import BertTokenizer, BertLMHeadModel, BertConfig
            >>> import torch
...
class BertForNextSentencePrediction(BertPreTrainedModel):
    ...
    def forward(
        ...
        Example::
            ...
            >>> from my_transformers import BertTokenizer, BertForNextSentencePrediction
            >>> import torch
