...
def set_args():
    ...
    parser.add_argument('--train_batch_size', type=int, default=16, help="random seed for initialization")
    parser.add_argument('--eval_batch_size', type=int, default=16, help="random seed for initialization")
