"""
@file   : run_unsupervised_simcse.py
@author : xiaolu
...
def get_parameters(model, model_init_lr, multiplier, classifier_lr, optimizer_grouped_parameters):
    lr = model_init_lr
...
if __name__ == '__main__':
    ...
    optimizer_grouped_parameters = get_parameters(model, args.learning_rate, args.learning_rate_decay,
                                                  args.classifier_lr, optimizer_grouped_parameters)
