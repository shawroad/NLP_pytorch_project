...
class SentenceBert(nn.Module):
    def __init__(self):
        ...
        self.config = AutoConfig.from_pretrained('./pretrain_weight/config.json')
        self.model = AutoModel.from_pretrained('./pretrain_weight/pytorch_model.bin', config=self.config)
