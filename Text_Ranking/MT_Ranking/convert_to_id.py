...
def convert_examples_to_features(data, max_seq_length, tokenizer):
    ...
    for item in tqdm(data):
        ...
        pos_encode = tokenizer_encoder(question, context, 1)
        neg_encode = tokenizer_encoder(question, neg_context, 0)
        features.append(pos_encode)
        features.append(neg_encode)
    return features
